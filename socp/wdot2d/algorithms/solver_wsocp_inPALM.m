function [var_out, runHist, sigma] = solver_wsocp_inPALM(var, opts, model)
%% An inexact proximal ALM for solving the SOCP reformulation of Weighted Dynamic Optimal Transport:
